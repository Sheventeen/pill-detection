...
import { type LLMModels, type STTModelString, type TTSModelString } from '../../src/inference/index.ts';
import { ChatContext, ChatMessage } from '../../src/llm/chat_context.ts';
import type { LLM, RealtimeModel, RealtimeModelError, ToolChoice } from '../../src/llm/index.ts';
import type { LLMError } from '../../src/llm/llm.ts';
import type { STT } from '../../src/stt/index.ts';
import type { STTError } from '../../src/stt/stt.ts';
import type { TTS, TTSError } from '../../src/tts/tts.ts';
import type { VAD } from '../../src/vad.ts';
import type { Agent } from '../../src/voice/agent.ts';
import type { _TurnDetector } from '../../src/voice/audio_recognition.ts';
import { AgentSessionEventTypes, type AgentState, type AgentStateChangedEvent, type CloseEvent, CloseReason, type ConversationItemAddedEvent, type ErrorEvent, type FunctionToolsExecutedEvent, type MetricsCollectedEvent, type SpeechCreatedEvent, type UserInputTranscribedEvent, type UserState, type UserStateChangedEvent } from '../../src/voice/events.ts';
import { AgentInput, AgentOutput } from '../../src/voice/io.ts';
import { type RoomInputOptions, type RoomOutputOptions } from '../../src/voice/room_io/index.ts';
import type { UnknownUserData } from '../../src/voice/run_context.ts';
...
export declare class AgentSession<UserData = UnknownUserData> extends AgentSession_base {
    ...
    interrupt(): import("../../src/utils.ts").Future<void>;
