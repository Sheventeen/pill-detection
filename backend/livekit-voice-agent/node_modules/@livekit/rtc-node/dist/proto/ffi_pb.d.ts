...
import { TrackEvent, GetStatsCallback, CreateVideoTrackRequest, CreateAudioTrackRequest, LocalTrackMuteRequest, EnableRemoteTrackRequest, GetStatsRequest, SetTrackSubscriptionPermissionsRequest, CreateVideoTrackResponse, CreateAudioTrackResponse, LocalTrackMuteResponse, EnableRemoteTrackResponse, GetStatsResponse, SetTrackSubscriptionPermissionsResponse } from '../../src/proto/track_pb.ts';
import { VideoStreamEvent, NewVideoStreamRequest, NewVideoSourceRequest, CaptureVideoFrameRequest, VideoConvertRequest, VideoStreamFromParticipantRequest, NewVideoStreamResponse, NewVideoSourceResponse, CaptureVideoFrameResponse, VideoConvertResponse, VideoStreamFromParticipantResponse } from '../../src/proto/video_frame_pb.ts';
import { AudioStreamEvent, CaptureAudioFrameCallback, NewAudioStreamRequest, NewAudioSourceRequest, CaptureAudioFrameRequest, ClearAudioBufferRequest, NewAudioResamplerRequest, RemixAndResampleRequest, AudioStreamFromParticipantRequest, NewSoxResamplerRequest, PushSoxResamplerRequest, FlushSoxResamplerRequest, LoadAudioFilterPluginRequest, NewApmRequest, ApmProcessStreamRequest, ApmProcessReverseStreamRequest, ApmSetStreamDelayRequest, NewAudioStreamResponse, NewAudioSourceResponse, CaptureAudioFrameResponse, ClearAudioBufferResponse, NewAudioResamplerResponse, RemixAndResampleResponse, AudioStreamFromParticipantResponse, NewSoxResamplerResponse, PushSoxResamplerResponse, FlushSoxResamplerResponse, LoadAudioFilterPluginResponse, NewApmResponse, ApmProcessStreamResponse, ApmProcessReverseStreamResponse, ApmSetStreamDelayResponse } from '../../src/proto/audio_frame_pb.ts';
import { E2eeRequest, E2eeResponse } from '../../src/proto/e2ee_pb.ts';
import { PerformRpcCallback, RpcMethodInvocationEvent, PerformRpcRequest, RegisterRpcMethodRequest, UnregisterRpcMethodRequest, RpcMethodInvocationResponseRequest, PerformRpcResponse, RegisterRpcMethodResponse, UnregisterRpcMethodResponse, RpcMethodInvocationResponseResponse } from '../../src/proto/rpc_pb.ts';
import { EnableRemoteTrackPublicationRequest, UpdateRemoteTrackPublicationDimensionRequest, EnableRemoteTrackPublicationResponse, UpdateRemoteTrackPublicationDimensionResponse } from '../../src/proto/track_publication_pb.ts';
import { ByteStreamReaderEvent, ByteStreamReaderReadAllCallback, ByteStreamReaderWriteToFileCallback, ByteStreamOpenCallback, ByteStreamWriterWriteCallback, ByteStreamWriterCloseCallback, StreamSendFileCallback, TextStreamReaderEvent, TextStreamReaderReadAllCallback, TextStreamOpenCallback, TextStreamWriterWriteCallback, TextStreamWriterCloseCallback, StreamSendTextCallback, ByteStreamReaderReadIncrementalRequest, ByteStreamReaderReadAllRequest, ByteStreamReaderWriteToFileRequest, TextStreamReaderReadIncrementalRequest, TextStreamReaderReadAllRequest, StreamSendFileRequest, StreamSendTextRequest, ByteStreamOpenRequest, ByteStreamWriterWriteRequest, ByteStreamWriterCloseRequest, TextStreamOpenRequest, TextStreamWriterWriteRequest, TextStreamWriterCloseRequest, ByteStreamReaderReadIncrementalResponse, ByteStreamReaderReadAllResponse, ByteStreamReaderWriteToFileResponse, TextStreamReaderReadIncrementalResponse, TextStreamReaderReadAllResponse, StreamSendFileResponse, StreamSendTextResponse, ByteStreamOpenResponse, ByteStreamWriterWriteResponse, ByteStreamWriterCloseResponse, TextStreamOpenResponse, TextStreamWriterWriteResponse, TextStreamWriterCloseResponse } from '../../src/proto/data_stream_pb.ts';
