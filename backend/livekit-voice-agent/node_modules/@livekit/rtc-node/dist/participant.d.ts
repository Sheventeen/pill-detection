import { a as BaseStreamInfo, e as ByteStreamOptions } from '../src/stream_reader-DRyR29vo.ts';
import { PathLike } from 'node:fs';
import { TrackPublishOptions } from '../src/proto/room_pb.ts';
import { TextStreamWriter, ByteStreamWriter } from '../src/data_streams/stream_writer.ts';
import '../src/ffi_client.ts';
import { ParticipantInfo, OwnedParticipant, ParticipantKind, DisconnectReason } from '../src/proto/participant_pb.ts';
import { PerformRpcParams, RpcInvocationData } from '../src/rpc.ts';
import { LocalTrack } from '../src/track.ts';
import { TrackPublication, LocalTrackPublication, RemoteTrackPublication } from '../src/track_publication.ts';
import { Transcription } from '../src/transcription.ts';
