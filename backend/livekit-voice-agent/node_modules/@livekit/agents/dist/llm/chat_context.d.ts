...
import { type ProviderFormat } from '../../src/llm/provider_format/index.ts';
import type { JSONObject, JSONValue, ToolContext } from '../../src/llm/tool_context.ts';
...
export declare class ChatContext {
    ...
    toProviderFormat(format: ProviderFormat, injectDummyUserMessage?: boolean): Promise<Record<string, any>[] | [Record<string, any>[], import("../../src/llm/provider_format/google.ts").GoogleFormatData]>;
    /**
